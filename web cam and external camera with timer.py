...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.b2.setGeometry(QtCore.QRect(220, 460, 93, 28))
        ...
        self.b.clicked.connect(self.bv)
        self.b.clicked.connect(self.bb)
        self.b2.clicked.connect(self.m)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b2.setText(_translate("MainWindow", "cam2"))
    ...
    def m(self):
        ...
        while True:
            ret,imgee=cap.read()
            cv2.imwrite("frame%d.jpg"%count,imgee)

            self.l.setPixmap(QtGui.QPixmap("frame%d.jpg"%count,imgee))
            count+=1
            if count>2:
                k=int(count)-2
                os.remove("frame%d.jpg"%k)
            k=cv2.waitKey(30)&0xff
            if k==27:
                break
        vidcap.release()
